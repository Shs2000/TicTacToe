...
public class tictactoe {
	public static void main(String[] args) {
		...
		while (!CheckWin(tablero, "O") && !CheckWin(tablero, "X") && !(iteraciones==9)) {
			Matrix(tablero);
			Player(myScan, tablero, jugador);
			CheckWin(tablero, jugador);
	...
	private static void Matrix(String[] tablero) {
	...
	private static void Player(Scanner myScan, String[] tablero, String jugador) {
		int eleccion;
